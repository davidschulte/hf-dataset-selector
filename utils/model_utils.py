...
EMBEDDING_SIZE = MODELS[MODEL_NAME]['embedding_size']


def create_base_model(model_name=MODEL_NAME):
...
def create_tokenizer(model_name=MODEL_NAME):
...
# TODO: raise or exception?
def get_pooled_output(base_model, input_ids, attention_mask):
